...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="Target" Type="RT myRIO">
		...
		<Property Name="alias.value" Type="Str">roboRIO-1038-FRC.local</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Controls" Type="Folder">
			<Item Name="Acquisition &amp; Scoring.ctl" Type="VI" URL="../Acquisition &amp; Scoring.ctl"/>
			<Item Name="Auton Defenses Enum.ctl" Type="VI" URL="../Auton Defenses Enum.ctl"/>
			<Item Name="AutoStatesTypeDef.ctl" Type="VI" URL="../AutoStatesTypeDef.ctl"/>
			<Item Name="Pnematics.ctl" Type="VI" URL="../Pnematics.ctl"/>
			<Item Name="Robot Drive.ctl" Type="VI" URL="../Robot Drive.ctl"/>
			<Item Name="Robot Values.ctl" Type="VI" URL="../Robot Values.ctl"/>
			<Item Name="Sensors.ctl" Type="VI" URL="../Sensors.ctl"/>
		</Item>
		<Item Name="Globals" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Robot Values.vi" Type="VI" URL="../Robot Values.vi"/>
			<Item Name="Vision Target Values.vi" Type="VI" URL="../Vision Target Values.vi"/>
			<Item Name="Robot Global.vi" Type="VI" URL="../Robot Global.vi"/>
		</Item>
		<Item Name="Support Code" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Coerced with Sign.vi" Type="VI" URL="../Coerced with Sign.vi"/>
			<Item Name="Digital Encoder Counter.vi" Type="VI" URL="../Digital Encoder Counter.vi"/>
			<Item Name="Drive Toggle 2016.vi" Type="VI" URL="../Drive Toggle 2016.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
			<Item Name="Toggle.vi" Type="VI" URL="../Toggle.vi"/>
			<Item Name="Square with Sign.vi" Type="VI" URL="../Square with Sign.vi"/>
			<Item Name="Auton Position Enum.vi" Type="VI" URL="../Auton Position Enum.vi"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			<Item Name="1038 Timer.vi" Type="VI" URL="../1038 Timer.vi"/>
			<Item Name="Align to Shoot.vi" Type="VI" URL="../Align to Shoot.vi"/>
			<Item Name="Arm Motor Control.vi" Type="VI" URL="../Arm Motor Control.vi"/>
			<Item Name="Auton Reaquire.vi" Type="VI" URL="../Auton Reaquire.vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Autonomous Independent.vi"/>
			<Item Name="Autonomous shoot.vi" Type="VI" URL="../Autonomous shoot.vi"/>
			<Item Name="Begin.vi" Type="VI" URL="../Begin.vi"/>
			<Item Name="Check Lowbar Cross.vi" Type="VI" URL="../Check Lowbar Cross.vi"/>
			<Item Name="Defense_Int_to_Enum.vi" Type="VI" URL="../Defense_Int_to_Enum.vi"/>
			<Item Name="Disabled.vi" Type="VI" URL="../Disabled.vi"/>
			<Item Name="Drive Straight Gyro.vi" Type="VI" URL="../Drive Straight Gyro.vi"/>
			<Item Name="Drive Straight.vi" Type="VI" URL="../Drive Straight.vi"/>
			<Item Name="Driver.vi" Type="VI" URL="../Driver.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../Finish.vi"/>
			<Item Name="Hanging.vi" Type="VI" URL="../Hanging.vi"/>
			<Item Name="Master Sensor Update.vi" Type="VI" URL="../Master Sensor Update.vi"/>
			<Item Name="Move Drive Motors.vi" Type="VI" URL="../Move Drive Motors.vi"/>
			...
			<Item Name="Shifter Toggle.vi" Type="VI" URL="../Shifter Toggle.vi"/>
			<Item Name="ShooterMotor.vi" Type="VI" URL="../ShooterMotor.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Teleop.vi"/>
			<Item Name="Turn Angle.vi" Type="VI" URL="../Turn Angle.vi"/>
